...
public class Menu {
    ...
    private void newAccount(){
        ...
        double userMoney = input.nextDouble();
        System.out.println("Do you want a Savings or Checking Account?");
        String userAcct = input.next();
        if (userAcct.equalsIgnoreCase("checking")) {
            ...
            SavingsAccount account = new SavingsAccount(userMoney,Account.getNumAccounts(), interest);
            assert customer != null;
            customer.addSavingsAccount(account);
            System.out.println("New account opened." + account.getAccNum());
